...
namespace ContactManager.Presenters
{
    ...
    class SideBarPhoneConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (contact.OfficePhone != null && !contact.OfficePhone.Equals(""))
            {
                activePhone = contact.OfficePhone;
            }
            else if (contact.CellPhone != null && !contact.CellPhone.Equals(""))
            {
                activePhone = contact.CellPhone;
            }
            else if (contact.HomePhone != null && !contact.HomePhone.Equals(""))
            {
